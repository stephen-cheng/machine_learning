...
# 指定三个初始质心
currentCenter1 = [2,1]; currentCenter2 = [11,9]; currentCenter3 = [12,3]
...
pl.plot([eachpoint[0] for eachpoint in group2], [eachpoint[1] for eachpoint in group2], 'og')
pl.plot([eachpoint[0] for eachpoint in group3], [eachpoint[1] for eachpoint in group3], 'ob')
