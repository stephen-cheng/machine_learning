...
# cf_contents based users and items matrix
...
# measure simi by consine
user_similarity = pairwise_distances(train_data_matrix, metric = "cosine")
item_similarity = pairwise_distances(train_data_matrix.T, metric = "cosine")

# predict based on items
...
print 'Item prediction: ', item_prediction[0]
...
# cf_model based sparse caculatation
